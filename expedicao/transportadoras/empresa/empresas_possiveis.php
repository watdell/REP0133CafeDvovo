...
<body>
    ...
    <div class="content">''
     ...
     ID_Destino <input type="text" id="empresa" name="empresa" >
     ID_Venda  <input type="text" id="pd" name="pd" >
     Quantidade(U):<input type="text" id="qnt" name="qnt" >
     Distancia(km):<input type="text" id="km" name="km" >
     Taxa:<input type="text" id="tx" name="tx" >
     Custo:<input type="text" id="custo" name="custo" >
     <div class="butons-div">
     <button type="button" class="button" onclick="acao()">Enviar</button>
