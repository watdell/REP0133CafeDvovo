            ...
            <fieldset class="fieldset">
                ...
                <div id="div-insumos">
                    <?php 
                        ...
                        $sqlInsumos = "SELECT insumo_id, nome FROM insumo";
                                ...
                                <select style="width: 70%;" class="insumo-select" id="insumo" name="insumo[]">
                                    <?php foreach ($insumosDisponiveis as $insumo) { ?>
                                        <option value="<?php echo $insumo['insumo_id']; ?>" data-custo_unitario="<?php echo $row['custo_unitario']; ?>"
                                            ...
                                            <?php echo $insumo['nome'] ." ----- R$ ".number_format($row['custo_unitario'], 2, ',', '.')." ".$row['unidade_medida']." ----- Estoque ".$row['estoque_atual']." ".$row['unidade_medida']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
