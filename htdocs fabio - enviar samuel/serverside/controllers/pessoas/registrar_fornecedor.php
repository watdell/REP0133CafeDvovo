...
if ($_POST) {
    ...
    $stmt_fornecedor = $conn->prepare("INSERT INTO fornecedor (fornecedor_id, nome_empresa, documento) VALUES (?, ?, ?);");
    $stmt_fornecedor->bind_param("iss", $ultimo_id, $nome_empresa, $cnpj_empresa);
    ...
    echo '<script>
            setTimeout(function() {
                window.location.href = "../../../public/cadastro-pessoas/fornecedor.php"; // Substitua pelo URL desejado
            }, 2000);
          </script>';
} else {
