    ...
    <main class="content">
        ...
        <div class="catalogo-container">
            <section class="catalogo-top">
                ...
                <!-- BARRA DE PROCURA -->
                <input id='search' class='procura' type='search' autocomplete="off" style='width:50%' placeholder='pesquisar por nome' oninput='search(this.value,"catalogo-grid")'></input>
                <div>
