...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/11/2024 às 18:58
...
--
-- Estrutura para tabela `itemorcamento`
--
...
--
-- Despejando dados para a tabela `itemorcamento`
--
...
(35, 47, 'Café Arábica', 'Café 100% Arábica de alta qual', 1554, '10'),
...
--
-- Estrutura para tabela `pos-vendas`
--
...
--
-- Estrutura para tabela `produto_insumo`
--
...
--
-- Despejando dados para a tabela `produto_insumo`
--
...
--
-- Despejando dados para a tabela `p_fisica`
--
...
--
-- Despejando dados para a tabela `p_juridica`
--
...
--
-- Índices de tabela `itemorcamento`
--
...
--
-- Índices de tabela `produto_insumo`
--
...
--
ALTER TABLE `itemorcamento`
  MODIFY `id_itemorcamento` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `orcamento`
  MODIFY `id_orcamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `vendas`
  MODIFY `idVendas` int(50) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária', AUTO_INCREMENT=2;
...
--
-- Restrições para tabelas `itemorcamento`
--
ALTER TABLE `itemorcamento`
...
--
-- Restrições para tabelas `pos-vendas`
--
ALTER TABLE `pos-vendas`
...
--
-- Restrições para tabelas `produto_insumo`
--
ALTER TABLE `produto_insumo`
